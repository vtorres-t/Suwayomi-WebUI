...
export type MangaRelatedPayload = {
    ...
    mangaTrackerRelated: Array<MangaTrackerRelated>;
};
...
export type MangaTrackerRelated = {
    __typename?: 'MangaTrackerRelated';
    recommendations: Array<TrackRelatedMangaType>;
    relations: Array<TrackRelatedMangaType>;
