...
export type GetCategoryMangasQuery = {
    __typename: 'Query', category: {
        __typename: 'CategoryType', id: number, mangas: {
...
export type RefreshMangaMutation = {
    __typename: 'Mutation', fetchMangaAndChapters: {
...
export type GetMigratableSourceMangasQuery = {
    __typename: 'Query', mangas: {
        __typename: 'MangaNodeList', nodes: Array<{
            __typename: 'MangaType',
            artist: string | null,
            author: string | null,
            id: number,
...
export type ResetServerSettingsMutation = {
    __typename: 'Mutation', resetSettings: {
        __typename: 'ResetSettingsPayload', settings: {
            __typename: 'SettingsType',
            ip: string,
            port: number,
            socksProxyEnabled: boolean,
...
export type UpdateServerSettingsMutation = {
    __typename: 'Mutation', setSettings: {
        __typename: 'SetSettingsPayload', settings: {
            __typename: 'SettingsType',
            ip: string,
            port: number,
            socksProxyEnabled: boolean,
...
export type GetMigrationSourceMangasFetchMutation = {
    __typename: 'Mutation', fetchSourceManga: {
        __typename: 'FetchSourceMangaPayload', hasNextPage: boolean, mangas: Array<{
            __typename: 'MangaType',
            artist: string | null,
            author: string | null,
            id: number,
...
export type UpdateSourcePreferencesMutation = {
    __typename: 'Mutation', updateSourcePreference: {
        __typename: 'UpdateSourcePreferencePayload', source: {
            __typename: 'SourceType',
            id: string,
            name: string,
            displayName: string,
...
export type GetMangaRelatedQuery = {
    ...
    mangaRelated: {
        ...
        mangaTrackerRelated: Array<{
            __typename: 'MangaTrackerRelated',
            trackerId: number,
...
export type UpdateLibraryMutation = {
    __typename: 'Mutation', updateLibrary: {
        __typename: 'UpdateLibraryPayload', updateStatus: {
            __typename: 'LibraryUpdateStatus',
            jobsInfo: {
                __typename: 'UpdaterJobsInfoType',
                isRunning: boolean,
...
export type GetUpdateStatusQuery = {
    __typename: 'Query', libraryUpdateStatus: {
        __typename: 'LibraryUpdateStatus',
        jobsInfo: {
            __typename: 'UpdaterJobsInfoType',
            isRunning: boolean,
...
export type UpdaterSubscription = {
    __typename: 'Subscription', libraryUpdateStatusChanged: {
        __typename: 'UpdaterUpdates',
        omittedUpdates: boolean,
        jobsInfo: {
            __typename: 'UpdaterJobsInfoType',
