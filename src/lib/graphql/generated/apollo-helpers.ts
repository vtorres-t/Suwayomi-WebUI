...
export type DirectoryStatsKeySpecifier = (
    | 'availableSpace'
    | 'availableSpacePretty'
    | 'folderSize'
    | 'folderSizePretty'
    | DirectoryStatsKeySpecifier
)[];
...
export type MangaTrackerRelatedKeySpecifier = (
    | 'recommendations'
    | 'relations'
    | 'trackerId'
    | MangaTrackerRelatedKeySpecifier
)[];
...
export type TrackRelatedMangaTypeKeySpecifier = (
    | 'coverUrl'
    | 'relationType'
    | 'remoteId'
    | 'title'
    | 'trackingUrl'
    | TrackRelatedMangaTypeKeySpecifier
)[];
